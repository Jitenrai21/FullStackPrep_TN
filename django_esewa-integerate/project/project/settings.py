...
SECRET_KEY = 'django-insecure-#9di=il12_m%$$#a43_g@p0_fr0ml7urs8)*t=c3-qzioglz6c'
...
ESEWA_CONFIG = {
    ...
    "SUCCESS_URL": "http://localhost:8000/shop/payment_success/",
    "FAILURE_URL": "http://localhost:8000/shop/payment_failed/",
